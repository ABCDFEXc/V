...
def pak():
		...
		with tred(max_workers=30) as zain:
			...
			for psx in user:
				ids = code+psx
				passlist = [psx,ids,'Arman123','Afghan123','afghan123','Afghan1234','afghan1234','Afghan12345','afghan12345','۱۲۳۴۵۶','100200','10002000','500500','500600','Afghanistan','afghanistan','۱۲۳۴۵۶۷۸۹','Kabul123','Kabul12345']
